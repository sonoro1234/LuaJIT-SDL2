...
-- example from https://github.com/torch/sdl2-ffi
-- with async callback added
...
desired.channels = 2
desired.samples = 512
desired.callback = sdl.MakeAudioCallback(mixaudio)
...
while sound.pos < sound.length do end
