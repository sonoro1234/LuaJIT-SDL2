...
void SDL_Quit(void);]]
ffi.cdef[[static const int HAVE_WINAPIFAMILY_H = 0;
static const int WINAPI_FAMILY_WINRT = 0;
static const int __WINDOWS__ = 1;
static const int __WIN32__ = 1;
static const int HAVE_STDINT_H = 1;
static const int SIZEOF_VOIDP = 4;
static const int HAVE_DDRAW_H = 1;
static const int HAVE_DINPUT_H = 1;
static const int HAVE_DSOUND_H = 1;
static const int HAVE_DXGI_H = 1;
static const int HAVE_XINPUT_H = 1;
static const int HAVE_MMDEVICEAPI_H = 1;
static const int HAVE_AUDIOCLIENT_H = 1;
static const int HAVE_ENDPOINTVOLUME_H = 1;
static const int HAVE_STDARG_H = 1;
static const int HAVE_STDDEF_H = 1;
...
static const int main = SDL_main;
